    ...
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p> Imperial Swap will be the home of our new frontend, and provides
              an interface for all interactions with the ImperialSwap protocol.
          </p>
      ...
      return (
        <div>
          <StyledLink target="_blank" href="#">
            Click here to access ImperialSwap
          </StyledLink>
        </div>
      )
    }
